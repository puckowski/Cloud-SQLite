...
** SQLITE_SOURCE_ID "2024-01-07 20:27:54 40f0a29e6dd90fcb969d7c0e49728ba0ee8f31d9e8f502b9a21469620a8aalt1"
**
...
var _sqlite3__wasm_pstack_ptr = Module['_sqlite3__wasm_pstack_ptr'] = createExportWrapper('sqlite3__wasm_pstack_ptr');
var _sqlite3__wasm_pstack_restore = Module['_sqlite3__wasm_pstack_restore'] = createExportWrapper('sqlite3__wasm_pstack_restore');
var _sqlite3__wasm_pstack_alloc = Module['_sqlite3__wasm_pstack_alloc'] = createExportWrapper('sqlite3__wasm_pstack_alloc');
var _sqlite3__wasm_pstack_remaining = Module['_sqlite3__wasm_pstack_remaining'] = createExportWrapper('sqlite3__wasm_pstack_remaining');
var _sqlite3__wasm_pstack_quota = Module['_sqlite3__wasm_pstack_quota'] = createExportWrapper('sqlite3__wasm_pstack_quota');
var _sqlite3__wasm_db_error = Module['_sqlite3__wasm_db_error'] = createExportWrapper('sqlite3__wasm_db_error');
var _sqlite3__wasm_test_struct = Module['_sqlite3__wasm_test_struct'] = createExportWrapper('sqlite3__wasm_test_struct');
var _sqlite3__wasm_enum_json = Module['_sqlite3__wasm_enum_json'] = createExportWrapper('sqlite3__wasm_enum_json');
var _sqlite3__wasm_vfs_unlink = Module['_sqlite3__wasm_vfs_unlink'] = createExportWrapper('sqlite3__wasm_vfs_unlink');
var _sqlite3__wasm_db_vfs = Module['_sqlite3__wasm_db_vfs'] = createExportWrapper('sqlite3__wasm_db_vfs');
var _sqlite3__wasm_db_reset = Module['_sqlite3__wasm_db_reset'] = createExportWrapper('sqlite3__wasm_db_reset');
var _sqlite3__wasm_db_export_chunked = Module['_sqlite3__wasm_db_export_chunked'] = createExportWrapper('sqlite3__wasm_db_export_chunked');
var _sqlite3__wasm_db_serialize = Module['_sqlite3__wasm_db_serialize'] = createExportWrapper('sqlite3__wasm_db_serialize');
var _sqlite3__wasm_vfs_create_file = Module['_sqlite3__wasm_vfs_create_file'] = createExportWrapper('sqlite3__wasm_vfs_create_file');
var _sqlite3__wasm_posix_create_file = Module['_sqlite3__wasm_posix_create_file'] = createExportWrapper('sqlite3__wasm_posix_create_file');
var _sqlite3__wasm_kvvfsMakeKeyOnPstack = Module['_sqlite3__wasm_kvvfsMakeKeyOnPstack'] = createExportWrapper('sqlite3__wasm_kvvfsMakeKeyOnPstack');
var _sqlite3__wasm_kvvfs_methods = Module['_sqlite3__wasm_kvvfs_methods'] = createExportWrapper('sqlite3__wasm_kvvfs_methods');
var _sqlite3__wasm_vtab_config = Module['_sqlite3__wasm_vtab_config'] = createExportWrapper('sqlite3__wasm_vtab_config');
var _sqlite3__wasm_db_config_ip = Module['_sqlite3__wasm_db_config_ip'] = createExportWrapper('sqlite3__wasm_db_config_ip');
var _sqlite3__wasm_db_config_pii = Module['_sqlite3__wasm_db_config_pii'] = createExportWrapper('sqlite3__wasm_db_config_pii');
var _sqlite3__wasm_db_config_s = Module['_sqlite3__wasm_db_config_s'] = createExportWrapper('sqlite3__wasm_db_config_s');
var _sqlite3__wasm_config_i = Module['_sqlite3__wasm_config_i'] = createExportWrapper('sqlite3__wasm_config_i');
var _sqlite3__wasm_config_ii = Module['_sqlite3__wasm_config_ii'] = createExportWrapper('sqlite3__wasm_config_ii');
var _sqlite3__wasm_config_j = Module['_sqlite3__wasm_config_j'] = createExportWrapper('sqlite3__wasm_config_j');
var _sqlite3__wasm_init_wasmfs = Module['_sqlite3__wasm_init_wasmfs'] = createExportWrapper('sqlite3__wasm_init_wasmfs');
var _sqlite3__wasm_test_intptr = Module['_sqlite3__wasm_test_intptr'] = createExportWrapper('sqlite3__wasm_test_intptr');
var _sqlite3__wasm_test_voidptr = Module['_sqlite3__wasm_test_voidptr'] = createExportWrapper('sqlite3__wasm_test_voidptr');
var _sqlite3__wasm_test_int64_max = Module['_sqlite3__wasm_test_int64_max'] = createExportWrapper('sqlite3__wasm_test_int64_max');
var _sqlite3__wasm_test_int64_min = Module['_sqlite3__wasm_test_int64_min'] = createExportWrapper('sqlite3__wasm_test_int64_min');
var _sqlite3__wasm_test_int64_times2 = Module['_sqlite3__wasm_test_int64_times2'] = createExportWrapper('sqlite3__wasm_test_int64_times2');
var _sqlite3__wasm_test_int64_minmax = Module['_sqlite3__wasm_test_int64_minmax'] = createExportWrapper('sqlite3__wasm_test_int64_minmax');
var _sqlite3__wasm_test_int64ptr = Module['_sqlite3__wasm_test_int64ptr'] = createExportWrapper('sqlite3__wasm_test_int64ptr');
var _sqlite3__wasm_test_stack_overflow = Module['_sqlite3__wasm_test_stack_overflow'] = createExportWrapper('sqlite3__wasm_test_stack_overflow');
var _sqlite3__wasm_test_str_hello = Module['_sqlite3__wasm_test_str_hello'] = createExportWrapper('sqlite3__wasm_test_str_hello');
var _sqlite3__wasm_SQLTester_strglob = Module['_sqlite3__wasm_SQLTester_strglob'] = createExportWrapper('sqlite3__wasm_SQLTester_strglob');
...
globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3){
  sqlite3.version = {"libVersion": "3.45.0", "libVersionNumber": 3045000, "sourceId": "2024-01-07 20:27:54 40f0a29e6dd90fcb969d7c0e49728ba0ee8f31d9e8f502b9a21469620a8aalt1","downloadVersion": 3450000};
});
globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3){
  const toss = (...args)=>{throw new Error(args.join(' '))};
